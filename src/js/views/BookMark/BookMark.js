...
const BookMark = ({ profileData=dummydata, tableClass,updateScheduleList, toggleTab, updatePartnerCampaginList,updateScheduler, permissions, isLoading }) => {
      ...
      return (
          <div>
              ...
              <div className="row">
                 ...
                 <h1 class="Profiles-title">Book Mark Details</h1>
                 </div>
                 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                 <button type="button" class="secondary-btn btn btn-secondary" onClick={eventToggle}>Create Book Mark</button>
                 </div>
              </div>
