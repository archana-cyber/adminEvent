...
const City = (props) => {
   ...
   const  { cityList=[], tableClass,updateScheduleList, toggleTab, updatePartnerCampaginList,updateScheduler, permissions, isLoading }= props
   const profileData=cityList 
  ...
  useEffect(()=>{
    ...
    if(deleteValue=='yes'){
        props.DeleteCityAction(getDeleteId,(res)=>{
            if(res.status==500){
...
//   const currentProfileList = scheduleLists;
  ...
  return (
      <div className={tableClass}>
          ...
          {(props.loader) ? <div className="loader-style" style={{ position: 'relative' }}> loading... </div> :
            ...
            <>
                  ...
                  <div className="row">
                    ...
                    <h1 class="Profiles-title">Cities Details</h1>
                    </div>
                    <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    <button type="button" class="secondary-btn btn btn-secondary" onClick={createCategoryHandler}>Create City</button>
                    </div>
                    </div>
                        <Row>  
                        <Col>
          ...
          {eventModal && <CityAdd data={editModal} showModalEvent={eventModal} toggleEvent={eventToggle}/>}
