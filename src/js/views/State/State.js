...
const State = (props) => {
   ...
   const  { stateList=[], tableClass,updateScheduleList, toggleTab, updatePartnerCampaginList,updateScheduler, permissions, isLoading }= props
   const profileData=stateList 
  ...
  useEffect(()=>{
    ...
    if(deleteValue=='yes'){
        props.DeleteStateAction(getDeleteId,(res)=>{
            if(res.status==500){
...
//   const currentProfileList = scheduleLists;
  ...
  return (
      <div className={tableClass}>
          ...
          {(props.loader) ? <div className="loader-style" style={{ position: 'relative' }}> loading... </div> :
            ...
            <>
                  ...
                  <div className="row">
                    ...
                    <h1 class="Profiles-title">State Details</h1>
                    </div>
                    <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    <button type="button" class="secondary-btn btn btn-secondary" onClick={createCategoryHandler}>Create State</button>
                    </div>
                    </div>
                        <Row>  
                        <Col>
          ...
          {eventModal && <StateAdd data={editModal} showModalEvent={eventModal} toggleEvent={eventToggle}/>}
